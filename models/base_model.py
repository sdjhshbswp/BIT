...
from models.wx_inputs import HistoryFeat
...
class BaseModel(nn.Module):
    ...
    def __init__(self, args):
        ...
        if not self.is_wx:
            from .Inputs import QueryFeat, SrcSessionFeat, ItemFeat, UserFeat
        else:
            from .wx_inputs import QueryFeat, SrcSessionFeat, ItemFeat, UserFeat
        ...
        if not self.is_wx:
            ...
            self.session_embedding = SrcSessionFeat(
                self.query_embedding,
                ItemFeat(self.query_embedding),
                UserFeat(),
                his_feat=HistoryFeat())
