...
def init_setting_Weixin():
    global load_path, user_vocab, query_vocab, src_train, src_val, src_test, rec_train, rec_val, rec_test

    load_path = "data/Weixin"
    # user_vocab = os.path.join(load_path, 'vocab/user_vocab.pkl')
    # query_vocab = os.path.join(load_path, 'vocab/query_vocab.pkl')

    src_train = os.path.join(load_path, 'sea_train.pkl')
    src_val = os.path.join(load_path, 'sea_test.pkl')
    src_test = os.path.join(load_path, 'sea_test.pkl')

    rec_train = os.path.join(load_path, 'rec_train.pkl')
    rec_val = os.path.join(load_path, 'rec_test.pkl')
    ...
    global user_id_num, _9000_num, _9001_num, _9002_num, _9003_num,\
        _9004_num, user_feature_list

    user_feature_list = [
        'user_id', '_9000', '_9001', '_9002',
        '_9003', '_9004'
    ]
    user_id_num = 11297 + 1
    _9000_num = 35 + 1
    ...
    global user_id_dim, _9000_dim, _9001_dim, _9002_dim, _9003_dim, _9004_dim
    user_id_dim = 32
    _9000_dim = 32
    _9001_dim = 32
    _9002_dim = 32
